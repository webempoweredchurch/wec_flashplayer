...
t3lib_extMgm::addPiFlexFormValue($_EXTKEY.'_pi1', 'FILE:EXT:wec_flashplayer/pi1/flexform_ds_video.xml');

t3lib_extMgm::addPlugin(Array("LLL:EXT:wec_flashplayer/locallang_db.php:tt_content.list_type_pi2", $_EXTKEY."_pi2"),"list_type");
t3lib_extMgm::addPiFlexFormValue($_EXTKEY.'_pi2', 'FILE:EXT:wec_flashplayer/pi2/flexform_ds_audio.xml');
...
t3lib_extMgm::addStaticFile($_EXTKEY,"static", "WEC Flash Player");
